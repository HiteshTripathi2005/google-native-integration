import { pgTable, serial, text, vector, timestamp, varchar, jsonb, integer } from 'drizzle-orm/pg-core';
...
export const messages = pgTable('messages', {
    ...
    messageParts: jsonb('message_parts').$type(), // Store complete AI response as structured parts
});
